...
set PSNR="PSNR_C.exe"
set logfile="log_LMSPREDcol_comp2.txt"
set OutFile=tmpLMScolcomp2.tsip
set res="res_LMScolcomp2.txt"
set res_de="res_LMScolcomp2_de.txt"
...
REM		for /L %%P in (6,6,18) do (
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -colpred 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -colpred 1 -rct 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM			)
REM	)
