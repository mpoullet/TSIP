...
set ENCODER="..\bin\TSIPcoder_2_12c.exe"
set DECODER="..\bin\TSIPcoder_2_12c.exe"
set PSNR="PSNR_C.exe"

set DIR=C:\Users\Strutz\Documents\Texte\Paper\2016-IEEE-JETCAS-SCF\Investigations\Testimages\PPM_trimmed

set res="01_SCF_2_12f.txt"
set Outfile="tmp212f.tsip"
set Logfile="log_SCF_2_12f_auto.txt"
set Recofile="reco212f.ppm"
