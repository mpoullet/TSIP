...
set PSNR="PSNR_C.exe"
set OutFile=tmpHXC2autoS.tsip
set LogFile=log_TSIP_Science_HXC2auto.txt
set res_en="res_HXC2auto_Science.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\Science\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\Science\*.ppm       
) do (
