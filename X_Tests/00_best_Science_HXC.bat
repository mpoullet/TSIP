...
REM 
set EXE="C:\Users\Strutz\Documents\C\TSIPcoder_1_34a\bin\TSIPcoder_1_34a.exe"
...
%EXE% -o %OutFile% -i nqueens.png  -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 30 -tolR3 30 -tolR4 45 -tolR5 45
set TOLG=-tolG0 0 -tolG1 0 -tolG2 6 -tolG3 6 -tolG4 19 -tolG5 19
set TOLB=-tolB0 0 -tolB1 0 -tolB2 12 -tolB3 12 -tolB4 55 -tolB5 55
set INCR=-HXC2increaseFac 1
...
%EXE% -o %OutFile% -i 408px-Killersudoku_color.png -histmode comp -method HXC2 %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i 5colors.png -histmode comp -method HXC2 %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i Alvarez_science_path.png -rct hp1 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i b001793kf7.png -rct RGB -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR%  -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i cov-journal-science-prev2-med.png -histmode comp -method HXC2 -HXC2auto 1  -log_name %LogFile% >> %res_en%
...
%EXE% -o %OutFile% -i F1_medium.png -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i computerized-tomography-us-heatmap.png -rct RGB -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i convert-pdf-to-bmp.png -histmode comp -method HXC2 -HXC2auto 1  -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i Cosmology_NEP.png  -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i g_black_hole.png -rct A2_1 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i hyades_n.png -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i I-love-science1024x768.png -rct RGB -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i img41.png -rct A2_10 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i inline-graphic-1.png -rct RGB -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i InVivoTarget1.png -rct RGB -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i MITP_USA_2008DEC_tomography_IDV_western_US_2_isosurfaces_planView_300km.png -rct B1_1 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 1 -tolR3 1 -tolR4 2 -tolR5 2
set TOLG=-tolG0 0 -tolG1 0 -tolG2 1 -tolG3 1 -tolG4 2 -tolG5 2
set TOLB=-tolB0 0 -tolB1 0 -tolB2 1 -tolB3 1 -tolB4 2 -tolB5 2
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i b001793kf8.png -rct A3_3 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR%  -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 0 -tolR5 0
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 0 -tolG5 0
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0
set INCR=-HXC2increaseFac 1
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i MICFig-121.png -rct A1_7 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i Portal_2_Potatoe_Science_Kit.png -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
...
%EXE% -o %OutFile% -i ncat_fig7_8.png -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i science-tweeps-influence-090422.png -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 11 -tolR1 11 -tolR2 11 -tolR3 11 -tolR4 11 -tolR5 11
set TOLG=-tolG0 5 -tolG1 5 -tolG2 6 -tolG3 6 -tolG4 7 -tolG5 7
set TOLB=-tolB0 1 -tolB1 1 -tolB2 1 -tolB3 1 -tolB4 1 -tolB5 1
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i science.png -rct A3_11 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i ScienceWeek2010_03.png -rct RGB -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i RXJ0852-46_radio.png -rct B2_1 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i science-fair-project-forum-ad.png -rct A2_1 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i science-papas-team.png -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i science_teacher.png -rct A1_6 -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i Science_Wraps_2010.png -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
%EXE% -o %OutFile% -i MICFig-122.png -histmode comp -method HXC2 -HXC2auto 1 -log_name %LogFile% >> %res_en%
...
set TOLR=-tolR0 2 -tolR1 2 -tolR2 8 -tolR3 8 -tolR4 8 -tolR5 8
set TOLG=-tolG0 3 -tolG1 3 -tolG2 10 -tolG3 10 -tolG4 22 -tolG5 22
set TOLB=-tolB0 5 -tolB1 5 -tolB2 8 -tolB3 8 -tolB4 8 -tolB5 8
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i inline-graphic-1.png -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 2 -tolR1 2 -tolR2 8 -tolR3 8 -tolR4 8 -tolR5 8
set TOLG=-tolG0 3 -tolG1 3 -tolG2 9 -tolG3 9 -tolG4 16 -tolG5 16
set TOLB=-tolB0 5 -tolB1 5 -tolB2 8 -tolB3 8 -tolB4 8 -tolB5 8
set INCR=-HXC2increaseFac 1
%EXE% -o %OutFile% -i inline-graphic-1.png -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
