...
set PSNR="PSNR_C.exe"
set OutFile=tmpAutoS.tsip
set LogFile=log_TSIP_Science_Auto.txt
set res_en="res_Auto_Science.txt"
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Science\Not-HXC\06-1986-dibias-science-art-41.png" (
 	set flag=1
  echo !flag!
 )
