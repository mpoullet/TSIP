...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\LargeImages\*.ppm       
	C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\PPM\LargeImages\*.ppm       
) do (

REM      C:\Users\Strutz\Documents\Daten\CT2\Test_Set\*.ppm       
REM      C:\Users\Strutz\Documents\Daten\CT2\Test_Set\*.png       
REM      C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\PPM\*.ppm     
REM      C:\Users\Strutz\Documents\Daten\USC\*.tiff      
 REM      C:\Users\Strutz\Documents\Daten\uwaterloo.ca\*.tif       
REM      C:\Users\Strutz\Documents\Daten\TZ5_PNG\*.png       
 REM     C:\Users\Strutz\Documents\Daten\TZ5_PPM\*.ppm       

REM       C:\Users\Strutz\Documents\Daten\CT2\Maps\*.png
 REM      C:\Users\Strutz\Documents\Daten\CT2\PWC-Corpus\*.ppm
REM	C:\Users\Strutz\Documents\Daten\CT2\Collection\*.ppm  
REM	C:\Users\Strutz\Documents\Daten\CT2\Collection\*.png       
REM	C:\Users\Strutz\Documents\Daten\CT2\Grey\*.ppm  
REM	C:\Users\Strutz\Documents\Daten\CT2\Grey\*.png       
REM	C:\Users\Strutz\Documents\Daten\LCIC\*.ppm  
REM       C:\Users\Strutz\Documents\Daten\CT2\LCIC_Medical\*.ppm       
REM      C:\Users\Strutz\Documents\Daten\CT2\Science\*.png

 REM     C:\Users\Strutz\Documents\Daten\CT2\Science\Not-HXC\*.png
 REM     C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\PPM\Not-HXC\*.ppm     

REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\LargeImages\We_are_anonymous.ppm" (
 	set flag=1
  echo !flag!
 )
...
REM %EXE% -i %%I -o tmp1.tsip -method BPC  -histMode none -Idx 0  1>> %res_en% 2>>&1
 ...
 %EXE% -i "%%I" -o tmpA.tsip -method COBaLP2 -constlines 0 -histMode comp -HXC2auto 1 -log_name log_TSIP_alle.txt >> %res_en% 
REM %EXE% -i tmpA.tsip -o recoA.ppm 
REM %PSNR% -i1 "%%I" -i2 recoA.ppm  -p  >> %res_en%
