...
REM 
set EXE="..\bin\TSIPcoder_2_16b.exe"
set PSNR="PSNR_C.exe"
set logfile="log_CoBaLP2_auto_kodimGrey_16b.txt"
set OutFile=tmpAuto_kodim_16b.tsip
set res="res_CoBaLP2_autoColour_kodim_16b.txt"
set res_de="res_CoBaLP2_de_16b.txt"
set DIR="..\..\..\Daten\"
