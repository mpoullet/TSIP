...
set PSNR="PSNR_C.exe"
set OutFile=tmpAutoLCIC.tsip
set LogFile=log_TSIP_LCIC_Auto.txt
set res_en="res_Auto_LCIC.txt"
...
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\LCIC\*.ppm  
) do (

echo %%I

REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\LCIC_Medical\endoscope1.ppm" (
 	set flag=1
  echo !flag!
 )
 ...
 REM %EXE% -i tmpL.tsip -o recoL.ppm  >> 
REM %PSNR% -i1 "%%I" -i2 recoL.ppm  -p  >> %res_en%
