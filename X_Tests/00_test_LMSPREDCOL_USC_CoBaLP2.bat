...
set PSNR="PSNR_C.exe"
set logfile="log_LMSPREDcol_compUSC.txt"
set OutFile=tmpLMScolcompUSC.tsip
set res="res_LMScolcompUSC.txt"
set res_de="res_LMScolcompUSC_de.txt"
...
set DIR="..\..\..\Texte\Paper\2015-CoBaLP2_colour\Investigations\Testimages_USC"
...
REM start with this images
 if "%%I" == "..\..\..\Texte\Paper\2015-CoBaLP2_colour\Investigations\Testimages_col\2mpampjjpg.ppm" (
 	set flag=1
  echo !flag!
 )
...
REM		for /L %%P in (6,6,18) do (
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -rct 1 -colpred 0 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -rct 1 -colpred 1 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -rct 1 -colpred 1 -colparal 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -colpred 0 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -colpred 1 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -colpred 1 -colparal 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM			)
REM	)
