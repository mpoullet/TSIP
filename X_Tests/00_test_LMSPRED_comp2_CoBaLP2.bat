...
set EXE="..\bin_debug\TSIPcoder_2_16.exe"
set EXE="..\bin\TSIPcoder_2_16.exe"
set PSNR="PSNR_C.exe"
set logfile="log_LMSPRED_comp2.txt"
set OutFile=tmpLMScomp2.tsip
set res="res_LMScomp2.txt"
set res_de="res_LMScomp2_de.txt"
...
REM start with this images
 if "%%I" == "..\..\..\Texte\Paper\2015-CoBaLP2_colour\Investigations\Testimages_YUV\bike.rgb_PNGOUT_b01_Y.pgm" (
 	set flag=1
  echo !flag!
 )
...
REM		for /L %%P in (6,6,18) do (
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM			)
REM	)
