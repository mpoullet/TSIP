...
set PSNR="PSNR_C.exe"
set OutFile=tmpLOCOS.tsip
set LogFile=log_TSIP_Science_LOCO.txt
set res_en="res_LOCO_Science.txt"
...
REM	C:\Users\Strutz\Documents\Daten\CT2\Science\*.ppm       

REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\Science\Not-HXC\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\Science\Not-HXC\*.ppm       
) do (
