...
set ENCODER="..\bin\TSIPcoder_2_13.exe"
set DECODER="..\bin\TSIPcoder_2_13.exe"
set PSNR="PSNR_C.exe"

set DIR=C:\Users\Strutz\Documents\Texte\Paper\2016-IEEE-JETCAS-SCF\Investigations\Testimages\PPM_trimmed

set res="01_SCF_2_13.txt"
set Outfile="tmp213.tsip"
set Logfile="log_SCF_2_13_auto.txt"
set Recofile="reco2_13.ppm"
