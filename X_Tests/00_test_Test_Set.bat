...
set res_en="res_test_Test_Set.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
      C:\Users\Strutz\Documents\Daten\CT2\Test_Set\Not-HXC\MMSposter-large.png       
) do (

echo %%I

REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Test_Set\DarkWorld.ppm" (
 	set flag=1
  echo !flag!
 )
 ...
 %EXE% -i "%%I" -o tmpT2.tsip -histmode comp -method cobalp2 -idx 0 -sT 0 -log_name log_TSIP_Test_Set.txt >> %res_en% 
REM %EXE% -i tmpT2.tsip -o reco2.ppm  
REM %PSNR% -i1 "%%I" -i2 reco2.ppm  -p  >> %res_en%
