...
set PSNR="PSNR_C.exe"
set OutFile=tmpAutoColl.tsip
set LogFile=log_TSIP_Coll_Auto.txt
set res_en="res_Auto_Coll.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
      C:\Users\Strutz\Documents\Daten\CT2\Collection\*.png       
      C:\Users\Strutz\Documents\Daten\CT2\Collection\*.ppm       
) do (
