...
set PSNR="PSNR_C.exe"
set OutFile=tmpHXC2autoW.tsip
set LogFile=log_TSIP_Wiki_HXC2auto.txt
set res_en="res_HXC2auto_Wiki.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\PPM\*.png       
...
REM  pngtopnm.exe %%I > tmp.ppm
 ...
 %EXE% -i %%I -o %OutFile% -method HXC2 -Idx 0 -HXC2auto 1 -histmode comp -pred none -log_name %LogFile% >> %res_en%
