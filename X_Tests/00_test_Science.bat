...
set OutFile=tmpScience.tsip
set LogFile=log_TSIP_Science.txt
set res_en="res_test_Science.txt"
set res_de="res_d_test_Science.txt"
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Science\b001793kf7.png" (
 	set flag=1
  echo !flag!
 )
