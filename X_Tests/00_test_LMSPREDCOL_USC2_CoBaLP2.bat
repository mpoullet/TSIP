...
set PSNR="PSNR_C.exe"
set logfile="log_LMSPREDcol_compUSC2.txt"
set OutFile=tmpLMScolcompUSC2.tsip
set res="res_LMScolcompUSC2.txt"
set res_de="res_LMScolcompUSC2_de.txt"
...
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -rct 1 -colpred 0 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -rct 1 -colpred 1 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
...
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -colpred 0 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method TSIP -pred lmspred -colpred 1 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
