...
REM 
set EXE="C:\Users\Strutz\Documents\C\TSIPcoder_1_33a\bin\TSIPcoder_1_33a.exe"
REM set EXE="..\bin_debug\TSIPcoder.exe"
set PSNR="PSNR_C.exe"

set OutFile=tmpbTS2.tsip
set LogFile=log_TSIP_Best_Wiki_auto.txt
...
set res_en="res_test_Wikisyn.txt"
set flag=0
...
%EXE% -i 	"267px-Surcoat_(PSF).ppm" -o %OutFile% -method BPC	-log_name %LogFile% >> %res_en%
...
%EXE% -i 	"613px-Scissors2_(PSF).ppm"	-o %OutFile% -histmode comp -method cobalp2 -sT 0	-log_name %LogFile% >> %res_en%
...
%EXE% -i 	"666px-Tandem_(PSF).ppm" -o %OutFile% -histmode comp -method cobalp2 -sT 1 -log_name %LogFile% >> %res_en%
...
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0
set INCR=-HXC2increaseFac 3
%EXE% -i 	686px-TSS_2.ppm -o %OutFile% -rct A2_3 -histmode none -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
...
%EXE% -i 800px-CompizNova2.1.ppm -o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 800px-Cow-2.ppm -o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 800px-Crankshaft_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-Diap3.1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-FBReader.0.10.7.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-Fig_4.4.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-Hunnenwanderung.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-LOM500_1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-MediaWikiExternalEditorImage.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"800px-Nickerie_(2).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-PFCS_.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-Piazza_(PSF).ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-Sporskifte_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-Spur3_(PSF).ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-SSadditiveblock.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-SvobodaOver5%.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	800px-TEDxPune_Logo_.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"800px-Thorax_(PSF).ppm"			-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"800px-Wagon_(Combi).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	819px-Montenegroetno03.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"857px-Frame_(PSF).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	889px-Pozi_screw_head_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	960px-Mynd_1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	A-4.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	A42.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Abadie.jo-Forme-1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	AbortionLawsMap.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Achsensymmetrie.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Acid2Firefox3.0.1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Acid3detailFirefox3_6.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Acid3Fx3_5.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Acid3iPod1.1.4.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Acting...ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Adminer03.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Adminpedia.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Aerocapture_(de).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"AgeStructureUa1897+.ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	AHPHierarchy02_1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	AHPHierarchy4_0.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Aimags.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Alosizes(v2).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Ambientocclusion-.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Android-2.3.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	ARA .ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Aragon.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Arsbreytinglandsfr2000-8.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	BALLZ.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Baltic_languages_PL.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Banner_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Barnstar_of_High_Culture.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Be-map.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	BeharQamar.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	BeirutMap_.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bellamy_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bellamy_3.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bellum_Hiemale_1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Benzaldehyde.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bermet..ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Bermudadreieck_(Skizze).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Bernard_Philippeaux_(1995).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bilde_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Blitz_logo_.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Boom_(PSF).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	BoxModelingSwanChairLeg4.5.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bpmn-1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bpmn-3.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Bulgarians_and_Slavs_VI-VII_century.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Byzantium650ADhy.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	C1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	C32_7.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Calvin_cycle_(cs).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Carpus.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Cartel_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	CatBurn-2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	CatBurn-3.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Cathedral_schematic_plan_fr.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"CellMembraneDrawing_(es).ppm"			-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Chansung.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Chart_of_popularity_of_health-themed_websites_.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Cheltenhamproblem..ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Chloroplasts_-_diffusion_of_photons.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	CicloCombinadoVSdemanda.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Cinnamon_1.6.7.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Coatofarmszeeland.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Colortest.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Common-whipping-binding-3.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Comparison_of_JPEG_and_PNG.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Compass_Card.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Contourgp1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Contourgpns1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Copolymers.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	CopticLetters.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Corollary_6.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Counties_of_Ireland,_sized_according_to_population_(2007).ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Coupe_.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Csite_(2).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"Cuckoo_(PSF).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"D3D_Pipeline_(en).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Danke-.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Debian.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	"DeltasABADMensual%.ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Denkmal.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	DeskNova1_1_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Dglogo_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
%EXE% -i 	Diadochi_2.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
...
%EXE% -i 	Inkscape_0.48.1.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
...
%EXE% -i 	MonogramaBGCP.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
...
%EXE% -i 	"Niele_Toroni_(1995).ppm"				-o %OutFile%	-log_name %LogFile% >> %res_en%
...
%EXE% -i 	Railroad1860.ppm				-o %OutFile%	-log_name %LogFile% >> %res_en%
