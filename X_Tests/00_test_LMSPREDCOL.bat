...
set EXE="..\bin\TSIPcoder_2_16.exe"
set PSNR="PSNR_C.exe"
set logfile="log_LMSPREDcol.txt"
set OutFile=tmpLMScol.tsip
set res="res_LMScol.txt"
set res_de="res_LMScol_de.txt"
set DIR="..\..\..\Daten\CT2\Grey"
set DIR="..\..\..\Texte\Paper\2015-CoBaLP2_colour\Investigations\Testimages_YUV"
set DIR="..\..\..\Texte\Paper\2015-CoBaLP2_colour\Investigations\Testimages_col"
set DIR="."
...
for  %%I in (   %DIR%\roud.bmp %DIR%\test2.PPM 
)do (
...
REM start with this images
 if "%%I" == "..\..\..\Texte\Paper\2015-CoBaLP2_colour\Investigations\Testimages_YUV\chart2_b01_Y.pgm" (
 	set flag=1
  echo !flag!
 )
...
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 11 -numOfPreds 12 -method TSIP -pred lmspred -colpred 0 -rct 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 11 -numOfPreds 12 -method TSIP -pred lmspred -colpred 1 -rct 1 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> c%res%
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 11 -numOfPreds 12 -method TSIP -pred lmspred -colpred 1 -rct 1 -colparal 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> cp%res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 11 -numOfPreds 12 -method TSIP -pred lmspred -colpred 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 11 -numOfPreds 12 -method TSIP -pred lmspred -colpred 1 -colparal 0 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> c%res%
		%EXE% -i %%I  -o %OutFile% -searchSpace 11 -numOfPreds 12 -method TSIP -pred lmspred -colpred 1 -colparal 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> cp%res%
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 5 -numOfPreds 18 -method TSIP -pred lmspred -colpred 0 -rct 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM		%EXE% -i %%I  -o %OutFile% -searchSpace 5 -numOfPreds 18 -method TSIP -pred lmspred -colpred 1 -rct 1 -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM			)
REM	)
