...
set PSNR="PSNR_C.exe"
set OutFile=tmpHXC2autoT.tsip
set LogFile=log_TSIP_Test_Set_HXC2auto.txt
set res_en="res_HXC2auto_Test_Set.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\*.ppm       
) do (
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Test_Set\ecb_berlin_07t.png" (
 	set flag=1
  echo !flag!
 )
...
REM
 ...
 %EXE% -i %%I -o %OutFile% -tilesize 100000 -method HXC2 -Idx 0 -HXC2auto 1 -histmode comp -pred none -log_name %LogFile% >> %res_en%
