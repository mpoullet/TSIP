...
set PSNR="PSNR_C.exe"
set OutFile=tmpAutoPWC.tsip
set LogFile=log_TSIP_PWC_Auto.txt
set res_en="res_Auto_PWC.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\PWC-Corpus\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\PWC-Corpus\*.ppm       
	C:\Users\Strutz\Documents\Daten\CT2\PWC-Corpus\Not_HXC\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\PWC-Corpus\Not_HXC\*.ppm       
) do (
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Test_Set\woodgrove.ppm" (
 	set flag=1
  echo !flag!
 )
