...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\PPM\Henry_IV_stayed_here.ppm" (
 	set flag=1
  echo !flag!
 )
...
REM %EXE% -i %%I -o tmp1.tsip -method BPC  -histMode none -Idx 0  1>> %res_en% 2>>&1
 ...
 %EXE% -i "%%I" -o tmp3.tsip -HXC2auto 1 -method LOCO -histMode comp -log_name log_TSIP_.txt >> %res_en% 
REM 
