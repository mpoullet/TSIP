...
set OutFile2=tmpMaxNum2.tsip
set LogFile2=log_TSIP_MaxNum2.txt
set res_en2="res_test_MaxNum2.txt"
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\777-Contest-PPM\InstallNova2_1.ppm" (
 	set flag=1
  echo !flag!
 )
...
REM  for /L %%F in (0,1,2) do (
    ...
    %EXE2% -i "%%I" -o %OutFile2% -method SCF -HXC2auto 1 -sT 1 -log_name %LogFile2% >> %res_en2% 
