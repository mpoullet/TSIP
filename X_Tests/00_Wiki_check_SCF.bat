...
REM 
set EXE2="..\bin\TSIPcoder_2_12l.exe"
REM set EXE="..\bin_debug\TSIPcoder.exe"
set PSNR="PSNR_C.exe"

set OutFile2=tmpMaxNum.tsip
set LogFile2=log_TSIP_MaxNum.txt
set res_en2="res_test_MaxNum.txt"
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\777-Contest-PPM\772px-2wdpanc_1.ppm" (
 	set flag=1
  echo !flag!
 )
...
REM  for /L %%F in (0,1,2) do (
    ...
    %EXE2% -i "%%I" -o %OutFile2% -method SCF -HXC2auto 1 -histmode comp -sT 1 -log_name %LogFile2% >> %res_en2% 
