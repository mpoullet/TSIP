...
REM 
set EXE="..\bin\TSIPcoder_2_12h_energy.exe"
REM set EXE="..\bin_debug\TSIPcoder.exe"
set PSNR="PSNR_C.exe"

set OutFile=tmpEnerg.tsip
set LogFile=log_TSIP_checkRCT_Energ.txt
...
set res_en="res_test_checkRCT.txt"
...
REM  for /L %%F in (0,1,2) do (
    ...
    %EXE% -i "%%I" -o %OutFile% -method loco -tilewidth 10000 -tileheight 10000 -log_name %LogFile% >> %res_en% 
