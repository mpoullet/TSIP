...
REM 
set EXE="..\bin\TSIPcoder_2_14a.exe"
REM set EXE="..\bin_debug\TSIPcoder.exe"
set PSNR="PSNR_C.exe"
set OutFile=tmpAutoT.tsip
set LogFile=log_TSIP_Test_Set_Auto.txt
set res_en="res_Auto_Test_Set.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\*.pngXXX       
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\*.ppmXXX       
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\Not_HXC\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\Not_HXC\*.ppm       
) do (
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Test_Set\Not_HXC\construction-06.ppm" (
 	set flag=1
  echo !flag!
 )
