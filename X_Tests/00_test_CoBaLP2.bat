...
set PSNR="PSNR_C.exe"
set logfile="log_CoBaLP2.txt"
set OutFile=tmpCoBaLP2.tsip
set res="res_CoBaLP2.txt"
set res_de="res_CoBaLP2_de.txt"
...
REM start with this images
 if %%I == ..\..\..\Texte\Paper\2015-CoBaLP2_colour\Investigations\Testimages_YUV\RNAi_dna_12bit.pgm (
 	set flag=1
  echo !flag!
 )
...
REM		for /L %%P in (6,6,18) do (
		%EXE% -i %%I  -o %OutFile% -searchSpace 19 -numOfPreds 18 -method CoBaLP2 -sT 0  -pred lspredho -tilewidth 9999999 -tileheight 999999 -log_name %logfile% >> %res%
REM			)
REM	)
