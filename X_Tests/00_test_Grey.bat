...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\Grey\*.ppm  
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Grey\endoscope1.ppm" (
 	set flag=1
  echo !flag!
 )
...
REM %EXE% -i tmpG.tsip -o recoG.ppm  >> 
REM %PSNR% -i1 "%%I" -i2 recoG.ppm  -p  >> %res_en%
