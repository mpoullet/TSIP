...
REM 
set EXE="..\bin\TSIPcoder_1_34e.exe"
REM set EXE="..\bin_debug\TSIPcoder.exe"
set PSNR="PSNR_C.exe"
set OutFile=tmpLOCOT.tsip
set LogFile=log_TSIP_Test_Set_LOCO.txt
set res_en="res_LOCO_Test_Set.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\Not-HXC\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\Test_Set\Not-HXC\*.ppm       
) do (
...
REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\Science\circuit-board.png" (
 	set flag=1
  echo !flag!
 )
...
REM if !flag! == 1 (
 ...
 %EXE% -i %%I -o %OutFile%  -method LOCO -Idx 0  -histmode comp -pred none -log_name %LogFile% >> %res_en%

REM  %EXE% -i tmp4.tsip -o reco4.ppm  >> %res_de%
REM  %PSNR% -i1 %%I -i2 reco4.ppm  -p  >> %res_en%
