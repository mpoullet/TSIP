...
set PSNR="PSNR_C.exe"
set OutFile=tmpLOCOG.tsip
set LogFile=log_TSIP_Grey_LOCO.txt
set res_en="res_LOCO_Grey.txt"
...
REM ##################### Main Loop ##############################
for  %%I in (                               
	C:\Users\Strutz\Documents\Daten\CT2\Grey\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\Grey\*.pgm       
	C:\Users\Strutz\Documents\Daten\CT2\Grey\Not-HXC\*.png       
	C:\Users\Strutz\Documents\Daten\CT2\Grey\Not-HXC\*.pgm       
) do (
