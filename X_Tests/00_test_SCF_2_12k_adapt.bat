...
set ENCODER="..\bin\TSIPcoder_2_12k.exe"
set DECODER="..\bin\TSIPcoder_2_12k.exe"
set PSNR="PSNR_C.exe"

set DIR=C:\Users\Strutz\Documents\Texte\Paper\2016-IEEE-JETCAS-SCF\Investigations\Testimages\PPM_trimmed

set res="01_SCF_2_12k.txt"
set Outfile="tmp212k.tsip"
set Logfile="log_SCF_2_12k_auto.txt"
set Recofile="reco212k.ppm"
