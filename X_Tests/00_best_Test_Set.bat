...
REM 
set EXE="C:\Users\Strutz\Documents\C\TSIPcoder_1_34a\bin\TSIPcoder_1_34c.exe"
REM set EXE="..\bin_debug\TSIPcoder.exe"
set PSNR="C:\Users\Strutz\Documents\C\TSIPcoder_1_34a\X_Tests\PSNR_C.exe"
...
if !flag! == 1 (
%EXE% -i DarkWorld.ppm  -o %OutFile% -method tsip -idx 1 -idx_sorting 0 -skip_rlc1 1 -IFCreset 8 -IFCmax 3 -log_name %LogFile% >> %res_en%
%EXE% -i DarkWorld.ppm  -o %OutFile% -tilesize 100000 -method tsip -idx 1 -idx_sorting 0 -skip_rlc1 1 -IFCreset 8 -IFCmax 3 -log_name %LogFile% >> %res_en%
%EXE% -i light_world-1_PNGOUT.ppm -o %OutFile% -tilesize 100000 -method tsip -histMode none -idx 1 -idx_sorting 0 -skip_rlc1 1 -IFCreset 7 -IFCmax 3  -log_name %LogFile% >> %res_en%
...
%EXE% -i Wikispecies-logo.ppm  -o tmpB1.tsip -method tsip -histMode kopt -idx 1 -idx_sorting 0 -skip_rlc1 1 -IFCreset 15 -IFCmax 5 -log_name %LogFile% >> %res_en%
...
%EXE% -i cubeiccp_PNGOUT.ppm  -o %OutFile% -rct 1 -method tsip -histMode comp -interleaving YYUUVV -skip_rlc1 1 -postBWT mtf -MTF_val 0  -log_name %LogFile% >> %res_en%
...
%EXE% -i Xcode_Shortcuts_B_W.ppm  -o %OutFile% -HXC2aouto 1 -method HXC2  -log_name %LogFile% >> %res_en%
%EXE% -i Xcode_Shortcuts_B_W.ppm  -o %OutFile% -tilesize 100000 -method tsip -histMode none -interleaving YY_uvuv -skip_rlc1 0 -postBWT mtf -MTF_val 0  -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 0 -tolR5 0 
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 0 -tolG5 0 
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0 
set INCR=-HXC2increaseFac 1
%EXE% -i orm-makeposter2008-14t.png  -o %OutFile% -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -i TF3D_Landscape.png  -o %OutFile% -idx 1 -idx_sorting 0 -method tsip -histMode comp  -skip_rlc1 1 -IFCreset 8 -IFCmax 3 -log_name %LogFile% >> %res_en%
...
%EXE% -i Tectonic_plates.png  -o %OutFile% -tilesize 100000 -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 1 -IFCreset 80 -IFCmax 5  -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 0 -tolR5 0 
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 0 -tolG5 0 
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0 
set INCR=-HXC2increaseFac 3
%EXE% -i mcn-cokedublin-43s.png  -o %OutFile% -rct A2_1 -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -i png-IceAlpha-ie5mac.ppm  -o %OutFile% -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 1 -postbwt MTF  -MTF_val 0  -log_name %LogFile% >> %res_en%
%EXE% -i PTHNWIDE_WaveletsGamma_LVGamp16Contp8.ppm  -o %OutFile% -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 1 -IFCreset 10 -IFCmax 3 -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 0 -tolR5 0 
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 0 -tolG5 0 
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0 
set INCR=-HXC2increaseFac 1
...
%EXE% -i _vector-music-melody-preview_PNGOUT.ppm  -o %OutFile% -method CoBaLP2 -sT 0 -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 0 -tolR5 0 
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 0 -tolG5 0 
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0 
set INCR=-HXC2increaseFac 2
...
%EXE% -i 248080202_731e632c11_o.png  -o %OutFile% -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 1 -IFCreset 5 -IFCmax 3 -log_name %LogFile% >> %res_en%
...
%EXE% -i Nukleationskern_Fluessigkeit.ppm  -o %OutFile% -method CoBaLP2 -sT 0 -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 0 -tolR5 0 
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 0 -tolG5 0 
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0 
set INCR=-HXC2increaseFac 3
%EXE% -i 500px-Roadmap_to_Unicode_BMP_de.svg.png  -o %OutFile% -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -i periodensystem-1280x887.png  -o %OutFile% -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 1 -postbwt MTF -mtf_val 0 -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 0 -tolR5 0 
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 0 -tolG5 0 
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 0 -tolB5 0 
set INCR=-HXC2increaseFac 1
%EXE% -i pie_charts_3d.ppm  -o %OutFile% -histmode comp -method HXC2  %TOLR% %TOLG% %TOLB% %INCR% -log_name %LogFile% >> %res_en%
%EXE% -i dev.ppm  -o %OutFile% -histmode comp -method HXC2 -log_name %LogFile% >> %res_en%
%EXE% -i Universe_expansion.png  -o %OutFile% -histmode none -method BPC -pred adapt -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 0 -tolR1 0 -tolR2 0 -tolR3 0 -tolR4 220 -tolR5 220 
set TOLG=-tolG0 0 -tolG1 0 -tolG2 0 -tolG3 0 -tolG4 220 -tolG5 220 
set TOLB=-tolB0 0 -tolB1 0 -tolB2 0 -tolB3 0 -tolB4 220 -tolB5 220 
set INCR=-HXC2increaseFac 1
...
%EXE% -i Landscape_002.png  -o %OutFile% -histmode none -method BPC -pred adapt  -log_name %LogFile% >> %res_en%
%EXE% -i png-8passes_PNGOUT.ppm  -o %OutFile% -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 0 -postbwt MTF -mtf_val 0 -log_name %LogFile% >> %res_en%
set TOLR=-tolR0 1 -tolR1 1 -tolR2 1 -tolR3 1 -tolR4 1 -tolR5 1 
...
%EXE% -i cover07_img10.png  -o %OutFile% -method tsip -histMode comp -interleaving YY_uvuv -skip_rlc1 0 -IFCreset 10 -IFCmax 5 -log_name %LogFile% >> %res_en%
%EXE% -i flaggen_580x2500_PNGOUT.ppm  -o %OutFile% -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 1 -IFCreset 3 -IFCmax 3 -log_name %LogFile% >> %res_en%
%EXE% -i hp3.ppm  -o %OutFile% -rct 1 -method BPC -histMode comp -log_name %LogFile% >> %res_en%
%EXE% -i lunar-lander.ppm  -o %OutFile% -method CoBaLP2 -sT 0 -constLines 1 -log_name %LogFile% >> %res_en%
%EXE% -i ImageConverter.png  -o %OutFile% -rct A3_1  -method tsip -histMode none -pred ADAPT -interleaving YY_uvuv -skip_rlc1 0 -RLC2_zeros 0 -IFCreset 5000 -IFCmax 300 -log_name %LogFile% >> %res_en%
...
%EXE% -i reactos_0.3.1_booklet_cover.png -o %OutFile% -method BPC -log_name %LogFile% >> %res_en%
...
%EXE% -i Tectonic_plates.png  -o %OutFile% -tilesize 100000 -idx 1 -idx_sorting 1 -method tsip -histMode none -skip_rlc1 0 -IFCreset 80 -IFCmax 5  -log_name %LogFile% >> %res_en%
...
%EXE% -i demos_gift-demo_PNGOUT.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i didle_PNGOUT.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i door-e5f8.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i demos_explorer_PNGOUT.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i Facade.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i face1.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i favicons_large_PNGOUT.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i flowers-y02o.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i gg.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i happybirds.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i home3.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i home4.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im1.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im10.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im12.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im14.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im15.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im19.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im2.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im20.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im4.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i im7.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i img-icons-a-png-official-macosx-leopard-icon-pack-daddy77-17777.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
%EXE% -i Jupiter_Earth_Comparison.ppm -o %OutFile% -log_name %LogFile% >> %res_en%
...
%EXE% -i window1.ppm -o %OutFile% -method CoBaLP2 -sT 1 -log_name %LogFile% >> %res_en%
...
%EXE% -i im3.ppm -o %OutFile% -method LOCO_T4 -log_name %LogFile% >> %res_en%
...
%EXE% -i brick.ppm -o %OutFile%  -method CoBaLP2 -sT 1 -constLines 1 -log_name %LogFile% >> %res_en%
...
%EXE% -i cement.ppm -o %OutFile% -method CoBaLP2 -sT 1 -constLines 1 -log_name %LogFile% >> %res_en%
...
%EXE% -i server.ppm -o %OutFile% -tilesize 1000000 -method CoBaLP2 -sT 1 -log_name %LogFile% >> %res_en%
%EXE% -i shadow.ppm -o %OutFile% -tilesize 1000000 -method CoBaLP2 -sT 1 -log_name %LogFile% >> %res_en%
%EXE% -i shadow.ppm -o %OutFile%  -method CoBaLP2 -sT 1 -log_name %LogFile% >> %res_en%
...
set INCR=-HXC2increaseFac 1
%EXE% -i Tectonic_plates.png  -o %OutFile% -histmode comp -method HXC2 -hxc2auto 1  -log_name %LogFile% >> %res_en%
