...
set EXE="..\bin\TSIPcoder_2_15c.exe"
set PSNR="PSNR_C.exe"
set logfile="log_CoBaLP2_auto_sT1_215c.txt"
set OutFile=tmpAuto.tsip
set res="res_CoBaLP2_autoColour_ABT_215c.txt"
set res_de="res_CoBaLP2_YUV_PA_de.txt"
...
REM start with this images
 if "%%I" == ".\Testimages_col\RNAi_dna_12bit.pgm" (
 	set flag=1
  echo !flag!
 )
 ...
 echo   %%I   >> %res%
  ...
  %EXE% -i %%I  -o %OutFile%  -method CoBaLP2 -sT 1 -log_name %logfile% >> %res%
REM %EXE% -i tmpA.tsip -o recoA.pgm  >> %res_de%
REM %PSNR% -i1 %%I -i2 recoA.pgm  -p  >> %res%
