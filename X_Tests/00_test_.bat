...
REM ##################### Main Loop ##############################
for  %%I in (                               
      C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\PPM\800px-MediaWikiExternalEditorImage.ppm      
) do (

REM start with this images
 if "%%I" == "C:\Users\Strutz\Documents\Daten\CT2\WikimediaCommons\PPM\meditate_fel_PNGOUT.ppm" (
 	set flag=1
  echo !flag!
 )
...
REM 
%EXE% -i "%%I" -o tmp3.tsip -method HXC2 -HXC2auto 1  -log_name log_TSIP.txt >> %res_en% 
%EXE% -i tmp3.tsip -o reco3.ppm 
REM 
%PSNR% -i1 "%%I" -i2 reco3.ppm  -p  >> %res_en%
